...
split_filename = "expressive_blendshapes_no_glasses_110326_test.h5"
# split_filename = "LOUD_GIP_generated_sentences_231210.h5"
########################
...
# Load split file based on extension
if split_full_path.suffix in ['.h5', '.hdf5']:
